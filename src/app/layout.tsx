...
export default function RootLayout({
  ...
  return (
    <html className="antialiased" lang="fr" suppressHydrationWarning>
      <body
        className={`flex min-h-screen w-full flex-col bg-zinc-50 dark:bg-zinc-900 ${nippo.variable} ${fontSans.variable}`}
      >
        <Providers>
          <Header />

          <main className="flex grow items-center justify-center font-nippo">
            {children}
          </main>
